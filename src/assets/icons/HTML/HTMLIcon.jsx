...
let HTMLIcon = (props) => {
    ...
    const FiveLeftHalf = props => <Shape path={[
        { x: 27.734375, y: 34.43359375, z: 10 },
        { x: 50, y: 34.43359375, z: 10 },
        { x: 50, y: 43.30078125, z: 10 },
        { x: 37.4609375, y: 43.30078125, z: 10 },
        { x: 38.28125, y: 52.3828125, z: 10 },
        { x: 50, y: 52.3828125, z: 10 },
        { x: 50, y: 61.230468750000014, z: 10 },
        { x: 30.15625, y: 61.230468750000014, z: 10 },
        { x: 27.734375, y: 34.43359375, z: 10 },
        { x: 27.734375, y: 34.43359375, z: 10 },
        { move: { x: 27.734375, y: 34.43359375, z: 10 }, },
        { x: 30.546875, y: 65.68359375000001, z: 10 },
        { x: 39.453125, y: 65.68359375000001, z: 10 },
        { x: 40.078125, y: 72.77343750000001, z: 10 },
        { x: 50, y: 75.42968750000001, z: 10 },
        { x: 50, y: 84.68750000000001, z: 10 },
        { x: 31.796875000000004, y: 79.60937500000001, z: 10 },
    ]} fill={"#ebebeb"} color={"#ebebeb"} closed={true} stroke={0}/>
    const FiveRightHalf = props => <Shape path={[
        { x: 72.1875, y: 34.43359375, z: 10 },
        { x: 49.9609375, y: 34.43359375, z: 10 },
        { x: 49.9609375, y: 43.30078125, z: 10 },
        { x: 71.3671875, y: 43.30078125, z: 10 },
        { x: 72.1875, y: 34.43359375, z: 10 },
        { move: { x: 70.56640624999999, y: 52.38281250000001 , z: 10}},
        { x: 49.9609375, y: 52.38281250000001, z: 10 },
        { x: 49.9609375, y: 61.25000000000001, z: 10 },
        { x: 60.8984375, y: 61.25000000000001, z: 10 },
        { x: 59.86328125, y: 72.7734375, z: 10 },
        { x: 49.9609375, y: 75.42968750000001, z: 10 },
        { x: 49.9609375, y: 84.6484375, z: 10 },
        { x: 68.125, y: 79.609375, z: 10 },
